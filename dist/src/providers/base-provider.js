...
var BaseService = (function () {
    ...
    // getBase function: get information from server with base path url
    BaseService.prototype.getBase = 
    // getBase function: get information from server with base path url
    function (baseUrl, path2, options) {
        var _this = this;
    ...
    // saveBase function: post in server with base path url
    BaseService.prototype.saveBase = 
    // saveBase function: post in server with base path url
    function (baseUrl, path2, payload, options) {
        var _this = this;
        if (options === void 0) { options = null; }
        this.baseurl = baseUrl;
        var d = new Date();
    ...
    // postRefreshToken function: if token of user is expired, send post to
    //                            request new token
    BaseService.prototype.postRefreshToken = 
    // postRefreshToken function: if token of user is expired, send post to
    //                            request new token
    function () {
        var _this = this;
